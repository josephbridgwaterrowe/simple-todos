...
module.exports = function (config) {
  ...
  config.set({
    ...
    // For some reason this doesn't work so we have a dummy-spec.js to make
    // karma pass whilst there are no real tests.
    //   You can find the dummy spec here: src/imports/utility/dummy-spec.js
